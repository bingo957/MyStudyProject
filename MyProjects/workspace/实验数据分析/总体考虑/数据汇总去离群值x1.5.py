...
def del_outlier(file_load):
    ...
    shutil.copy(file_load + '\\其它模板\\去离群值参数汇总.xlsx', os.curdir)
    app = xw.App(visible=True, add_book=True)
    app.display_alerts = True
    app.screen_updating = True
    wb = app.books.open('去离群值参数汇总.xlsx')
    for every_select_data in select_data:
        ...
        for i in cycle_num:
            ...
            deerta_sifenwei = (np.percentile(data_list1, 75, interpolation='lower') - np.percentile(data_list1, 25, interpolation='higher')) * 1.5
