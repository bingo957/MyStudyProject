...
def ion_vs_ioff(file_load):
    ...
    for i in cycle_num:
        ...
        excel_data_for_num_vth = pd.read_excel(os.curdir + '\\参数汇总处理.xlsx', sheet_name='ioff', usecols=[a + 1], header=0,
